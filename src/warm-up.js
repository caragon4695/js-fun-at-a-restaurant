...
var vegetables = ["carrots", "kale", "parsley", "beets", "radishes"];
...
// different fruits.
var fruits = ['apple', 'oranges', 'banana', 'kiwi', 'watermelon', 'grapefruit', 'lemon'];
...
// The address, hours, distance would all be great.
